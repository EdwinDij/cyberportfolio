...
const navItems: NavItem[] = [
  ...
  { label: "// Tarifs", href: "/#tarifs", scrollTo: "tarifs" },
...
export const Navbar = () => {
  ...
  return (
    <motion.header
      className="sticky max-sm:fixed top-0 w-full z-50 bg-background/80 backdrop-blur border-b border-border border-white/10 "
      initial={{ y: -100 }}
      animate={{ y: 0 }}
